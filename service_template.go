...
func GetServiceTemplate(serviceTemplate string, server string, username string, password string, allowInsecure bool) (ServiceTemplate, error) {

	var returnedBody ServiceTemplate
	var returnedError APIResponseError
	customTransport := http.DefaultTransport.(*http.Transport).Clone()

	req, err := http.NewRequest("DELETE", "https://"+server+"/api/config/service_template/"+serviceTemplate, nil)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func CreateServiceTemplate(data ServiceTemplate, server string, username string, password string, allowInsecure bool) (ServiceTemplate, error) {
	...
	req, err := http.NewRequest("POST", "https://"+server+"/api/config/service_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func UpdateServiceTemplate(data ServiceTemplate, server string, username string, password string, allowInsecure bool) (ServiceTemplate, error) {
	...
	body := bytes.NewReader(payloadBytes)
	req, err := http.NewRequest("PATCH", "https://"+server+"/api/config/service_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func ReplaceServiceTemplate(data ServiceTemplate, server string, username string, password string, allowInsecure bool) (ServiceTemplate, error) {
	...
	body := bytes.NewReader(payloadBytes)
	req, err := http.NewRequest("PUT", "https://"+server+"/api/config/service_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func DeleteServiceTemplate(serviceTemplate string, server string, username string, password string, allowInsecure bool) (string, error) {
