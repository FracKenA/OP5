...
func GetContactTemplate(contactTemplate string, server string, username string, password string, allowInsecure bool) (ContactTemplate, error) {

	var returnedBody ContactTemplate
	var returnedError APIResponseError
	customTransport := http.DefaultTransport.(*http.Transport).Clone()

	req, err := http.NewRequest("DELETE", "https://"+server+"/api/config/contact_template/"+contactTemplate, nil)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func CreateContactTemplate(data ContactTemplate, server string, username string, password string, allowInsecure bool) (ContactTemplate, error) {
	...
	req, err := http.NewRequest("POST", "https://"+server+"/api/config/contact_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func UpdateContactTemplate(data ContactTemplate, server string, username string, password string, allowInsecure bool) (ContactTemplate, error) {
	...
	body := bytes.NewReader(payloadBytes)
	req, err := http.NewRequest("PATCH", "https://"+server+"/api/config/contact_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func ReplaceContactTemplate(data ContactTemplate, server string, username string, password string, allowInsecure bool) (ContactTemplate, error) {
	...
	body := bytes.NewReader(payloadBytes)
	req, err := http.NewRequest("PUT", "https://"+server+"/api/config/contact_template", body)
	if err != nil {
		fmt.Printf("Error%s\n", err)
...
func DeleteContactTemplate(contactTemplate string, server string, username string, password string, allowInsecure bool) (string, error) {
